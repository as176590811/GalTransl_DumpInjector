...
def test_case_1():
    ...
    tab._on_script_jp_path_changed(jp_script_path)
    print()
...
def test_case_2():
    ...
    # 设置已经是子目录的路径
    tab.json_jp_selector.set_path(r"E:\game\script\json_jp")
    tab.json_cn_selector.set_path(r"E:\game\json_cn")
